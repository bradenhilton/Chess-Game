...
public class TestGame {
    private static boolean legalMove = false;
    ...
    private static Map<Integer, Character> reverseCharMap = new HashMap<Integer, Character>();

    private static List<String> moveHistory = new ArrayList<String>();
    private static List<Piece> capturedPieces = new ArrayList<Piece>();
    private static List<Piece> promotedPieces = new ArrayList<Piece>();
    private static List<String> allPossibleMoves = new ArrayList<String>();

    private static Scanner input = new Scanner(System.in);

    private static Player lastPlayer;
    private static Player currentPlayer;
    private static PieceType lastPiece;
    private static int lastPieceOldRank = 0;
    private static int lastPieceOldFile = 0;
    private static int lastPieceNewRank = 0;
    private static int lastPieceNewFile = 0;

    private static int blackKingR;
    private static int blackKingF;
    private static int whiteKingR;
    private static int whiteKingF;
    ...
    public TestGame(TestBoard tBoard, int numPlayers) {
        ...
        if (players >= 2) {
            ...
            new TestGameZeroplayer(board, charMap, reverseCharMap, whiteTurn);
        }
     ...
     */
    private static void testGame(TestBoard tBoard) {
     ...
     */
    public static void parseMoveTest(TestBoard tBoard, String move, boolean castle) {
     ...
     */
    public static List<String> listPossibleMoves(TestBoard tBoard, String piece) {
    ...
    public static boolean isCheck(TestBoard tBoard, List<String> possibleMoves) {
    ...
    public static boolean isCheckmate(TestBoard tBoard, List<String> possibleMoves) {
     ...
     */
    public static void getPieceInfo(TestBoard tBoard, String piece) {
     ...
     * @return Move value.
     */
    public static String alphaBeta(TestBoard tBoard, int depth, int beta, int alpha, String move,
        ...
        if (depth == 0 || allMoves.isEmpty()) {
            if (maximisingPlayer) {
                return move + String.valueOf(ratingInput());
     ...
     */
    public static void castle(TestBoard tBoard, int piece1Rank, int piece1File, int piece2Rank, int piece2File) {
        int kingRank = 0;
        int kingFile = 0;
        int rookRank = 0;
        int rookFile = 0;
     ...
     */
    public static void enPassant(TestBoard tBoard, int startRank, int startFile, int destRank, int destFile) {
     ...
     *            File of Pawn.
     */
    public static void promotePawn(TestBoard tBoard, int rank, int file) {
     ...
     *            Destination File.
     */
    public static void makeMove(TestBoard tBoard, int startRank, int startFile, int destRank, int destFile) {
     ...
     */
    public static void undoMove(TestBoard tBoard, List<String> history, List<Piece> captured, List<Piece> promoted) {
     ...
     */
    public static void lastMove(TestBoard tBoard, int startRank, int startFile, int destRank, int destFile,
            boolean castle, boolean enPassant, boolean capture, boolean promotion) {
     ...
     */
    public static boolean isLegalMove(TestBoard tBoard, int startRank, int startFile, int destRank, int destFile) {
