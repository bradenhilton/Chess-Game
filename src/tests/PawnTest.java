...
public class PawnTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("1) Move by One");
		System.out.println("2) Move by Two");
		System.out.println("3) Move by One (Blocked by White Piece)");
		System.out.println("4) Move by One (Blocked by Black Piece)");
		System.out.println("5) Capture Left");
		System.out.println("6) Capture Right");
		System.out.println("7) En-Passant");
		try {
		...
		switch (test) {
			case 1: boardArray[6][5] = new Pawn(Player.WHITE);
