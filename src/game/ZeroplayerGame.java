...
public class ZeroplayerGame {
    ...
    public ZeroplayerGame(Board chessBoard, Map<Character, Integer> cMap, Map<Integer, Character> reverseCMap,
            boolean turn) {
        board = chessBoard;
        charMap = cMap;
        ...
        zeroplayerGameLoop(board);
    }

    public void zeroplayerGameLoop(Board chessBoard) {
        while (!(gameOver || stalemate)) {
            ...
            if (move.substring(4).contains("castle")) {
                ...
                zeroplayerParseMove(chessBoard, move, true);
            } else {
                move = String.valueOf(startFile)
                        + String.valueOf(startRank + String.valueOf(destFile) + String.valueOf(destRank));
                zeroplayerParseMove(chessBoard, move, false);
            }
        }
    ...
    public void zeroplayerParseMove(Board chessBoard, String move, boolean castle) {
    ...
    public String alphaBetaWhite(Board chessBoard, int depth, int beta, int alpha, String move, int playerNum) {
        ...
        for (String m : allMoves) {
            ...
            String returnString = alphaBetaWhite(chessBoard, depth - 1, beta, alpha, m, playerNum);
    ...
    public String alphaBetaBlack(Board chessBoard, int depth, int beta, int alpha, String move, int playerNum) {
        List<String> allMoves = new ArrayList<String>();
        int startRank, startFile, destRank, destFile;
        int value;
        Player player;
        ...
        for (String m : allMoves) {
            ...
            String returnString = alphaBetaBlack(chessBoard, depth - 1, beta, alpha, m, playerNum);
            value = Integer.parseInt(returnString.substring(28));
