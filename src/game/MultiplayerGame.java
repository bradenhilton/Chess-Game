...
public class MultiplayerGame {
    ...
    public MultiplayerGame(Board chessBoard, Map<Character, Integer> cMap, Map<Integer, Character> reverseCMap,
            boolean turn) {
        ...
        allPossibleFriendlyMoves.clear();
        allPossibleEnemyMoves.clear();

        multiplayerLoop(board, whiteTurn);
    }
     ...
     */
    private void multiplayerLoop(Board chessBoard, boolean turn) {
        while (!(gameOver || stalemate)) {
            ...
            case "castle":
                ...
                if (!kingAndRook.matches("[a-hA-H][1-8][a-hA-H][1-8]")) {
                    ...
                    multiplayerParseMove(chessBoard, kingAndRook, whiteTurn, true);
                }
                break;
            default:
                multiplayerParseMove(chessBoard, move, whiteTurn, false);
                break;
            }
        }
        ...
        if (gameOver) {
            ...
            new MultiplayerGame(resetBoard, charMap, reverseCharMap, whiteTurn);
        }
    }

    public void multiplayerParseMove(Board chessBoard, String move, boolean turn, boolean castle) {
                    ...
                    for (int i = 0; i < allPossibleMoves.size(); i++) {
                        if (i + 1 == allPossibleMoves.size()
                            ...
                            if (castle == true || allPossibleMoves.get(i).substring(4).contains("castle")) {
                                ...
                                legalMove = true;
                                whiteTurn = !whiteTurn;
                                multiplayerLoop(chessBoard, whiteTurn);
